...
namespace Nop.Core.Plugins
{
    ...
    public interface IPluginFinder
    {
        ...
        bool AuthorizedForUser(PluginDescriptor pluginDescriptor, IAppUser customer);
        ...
        IEnumerable<T> GetPlugins<T>(LoadPluginsMode loadMode = LoadPluginsMode.InstalledOnly,
            IAppUser customer = null, int storeId = 0, string group = null) where T : class, IPlugin;
        ...
        IEnumerable<PluginDescriptor> GetPluginDescriptors(LoadPluginsMode loadMode = LoadPluginsMode.InstalledOnly,
            IAppUser customer = null, int storeId = 0, string group = null);
